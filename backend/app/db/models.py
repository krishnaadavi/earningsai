...
class GuidanceInsight(Base):
    __tablename__ = "guidance_insights"
    ...
    outlook_note: Mapped[str | None] = mapped_column(Text, nullable=True)
    confidence: Mapped[str | None] = mapped_column(String(32), nullable=True)
    source: Mapped[str | None] = mapped_column(String(32), nullable=True)
    source_chunk: Mapped[str | None] = mapped_column(String(64), nullable=True)
